...
class SimpleTeleopArm:
    ...
    def __init__(self, joint_map, initial_obs, kinematics, prefix="right", kp=1):
        ...
        Args:
            ...
            initial_obs (dict): Initial observation dictionary from the robot to set starting positions.
...
class SimpleHeadControl:
    ...
    def __init__(self, initial_obs, kp=1):
        ...
        Args:
            initial_obs (dict): Initial observation dictionary from the robot.
            kp (float, optional): Proportional gain for the control loop. Defaults to 1.
        """
        self.kp = kp
